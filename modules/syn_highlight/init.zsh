...
if ! zstyle -T ':zmodule:syntax-highlighting' color; then
  return 1
fi
...
# Set highlighters.
zstyle -a ':zmodule:syntax-highlighting' highlighters 'ZSH_HIGHLIGHT_HIGHLIGHTERS'
...
zstyle -a ':zmodule:syntax-highlighting' styles 'syntax_highlighting_styles'
...
zstyle -a ':zmodule:syntax-highlighting' pattern 'syntax_pattern_styles'
